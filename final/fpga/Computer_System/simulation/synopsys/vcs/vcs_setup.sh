...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_hps_input_data.v \
  $QSYS_SIMDIR/submodules/Computer_System_hps_input_addr.v \
  $QSYS_SIMDIR/submodules/Computer_System_hps_fclk.v \
  $QSYS_SIMDIR/submodules/Computer_System_fpga_output_data.v \
  $QSYS_SIMDIR/submodules/Computer_System_fpga_ack.v \
